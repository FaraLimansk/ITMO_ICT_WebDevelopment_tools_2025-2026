...
<!-- Вставить изображение: скриншот структуры папки lab3 с папками api, parser, worker, common и docker-compose.yml.
Предлагаемое имя файла: images/01-project-structure.png
-->
...
<!-- Вставить изображение: схема или скриншот, показывающий взаимодействие api, parser, redis, worker и db.
Предлагаемое имя файла: images/02-architecture.png
-->
...
## Последовательная проверка и скриншоты
...
Сделать скриншот терминала со сборкой и запуском контейнеров.

<!-- Вставить изображение: успешный docker compose up --build.
Предлагаемое имя файла: images/03-docker-build.png
-->
...
Сделать скриншот вывода `docker compose ps`.

<!-- Вставить изображение: список запущенных контейнеров docker compose ps.
Предлагаемое имя файла: images/04-compose-ps.png
-->
...
Сделать скриншот Swagger-документации API.

<!-- Вставить изображение: Swagger API-шлюза с endpoint-ами.
Предлагаемое имя файла: images/05-api-swagger.png
-->
...
Сделать скриншот запроса и ответа.

<!-- Вставить изображение: успешный ответ GET /health.
Предлагаемое имя файла: images/06-health.png
-->
...
Сделать скриншот результата прямого парсинга.

<!-- Вставить изображение: ответ POST /parse с title и status_code 200.
Предлагаемое имя файла: images/07-direct-parse.png
-->
...
Сделать скриншот SQL-вывода.

<!-- Вставить изображение: запись после прямого вызова в таблице parsed_pages.
Предлагаемое имя файла: images/08-http-database-row.png
-->
...
Сделать скриншот ответа с `task_id`.

<!-- Вставить изображение: постановка задачи Celery в очередь и полученный task_id.
Предлагаемое имя файла: images/09-task-queued.png
-->
...
Сделать скриншот завершённой задачи.

<!-- Вставить изображение: статус Celery-задачи SUCCESS и результат парсинга.
Предлагаемое имя файла: images/10-task-success.png
-->
...
Сделать скриншот логов worker.

<!-- Вставить изображение: логи Celery worker с выполненной задачей parse_url_task.
Предлагаемое имя файла: images/11-worker-logs.png
-->
...
Сделать скриншот таблицы с записью после выполнения фоновой задачи.

<!-- Вставить изображение: запись source=celery в таблице parsed_pages.
Предлагаемое имя файла: images/12-celery-database-row.png
-->
