...
<!-- Вставить изображение: скриншот структуры папки lab2 в IDE или проводнике.
Пример ссылки после загрузки файла:
...
<!-- Вставить изображение: скриншот запуска calculation.py с одинаковым результатом суммы и временем трёх реализаций.
Пример ссылки после загрузки файла:
...
<!-- Вставить изображение: скриншот запуска трёх parser-файлов с URL, заголовками страниц и статусом 200.
Пример ссылки после загрузки файла:
...
<!-- Вставить изображение: скриншот таблицы parsed_pages в SQLite Browser или вывода SQL-запроса с результатами.
Пример ссылки после загрузки файла:
...
<!-- Вставить изображение: скриншот таблицы с фактическими замерами времени выполнения.
Пример ссылки после загрузки файла:
